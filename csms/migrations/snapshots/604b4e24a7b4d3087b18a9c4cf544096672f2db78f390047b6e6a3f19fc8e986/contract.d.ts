...
export type StorageHash =
  StorageHashBase<'604b4e24a7b4d3087b18a9c4cf544096672f2db78f390047b6e6a3f19fc8e986'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Invoice: {
      ...
      readonly energyWh: CodecTypes['pg/int4@1']['output'];
      readonly tariffPaisePerKwh: CodecTypes['pg/int4@1']['output'];
      readonly amountPaise: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Invoice: {
      ...
      readonly energyWh: CodecTypes['pg/int4@1']['input'];
      readonly tariffPaisePerKwh: CodecTypes['pg/int4@1']['input'];
      readonly amountPaise: CodecTypes['pg/int4@1']['input'];
          ...
          readonly table: {
            ...
            readonly invoice: {
              columns: {
                ...
                readonly tariffPaisePerKwh: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: false;
                };
                readonly amountPaise: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: false;
                };
            ...
            readonly site: {
              columns: {
                ...
                readonly tariffPaisePerKwh: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/int4@1', 800>;
                  };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
          ...
          readonly Invoice: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly energyWh: { readonly column: 'energyWh' };
                readonly tariffPaisePerKwh: { readonly column: 'tariffPaisePerKwh' };
                readonly amountPaise: { readonly column: 'amountPaise' };
